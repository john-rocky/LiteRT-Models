...
#   gfpgan_fp16.tflite (431 MB, too large to bundle) + yunet_fp16.tflite (0.3 MB, face alignment).
# Get gfpgan_fp16.tflite from Hugging Face (litert-community/GFPGAN-v1.4-LiteRT) or build it with
# build_gfpgan.py; yunet_fp16.tflite from the yunet module. Then:
...
echo "done — launch the GFPGAN app."
