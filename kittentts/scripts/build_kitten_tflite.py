...
def main():
    convert_keras(build_predictor(), K.OUT / "kitten_predictor.tflite")
    convert_keras(build_prosody(), K.OUT / "kitten_prosody.tflite")
