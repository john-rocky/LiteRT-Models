...
#   graphs_dir     holds the .tflite chunks (scripts/chunked_export_klein.py,
#                  scripts/build_klein_enc.py, scripts/vae_deploy_klein.py, and for
#                  editing scripts/chunked_export_klein.py --edit +
#                  scripts/vae_encode_klein.py)
#   bins_dir       klein_bins/ written by scripts/gen_prep_klein.py
