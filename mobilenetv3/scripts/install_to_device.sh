#!/usr/bin/env bash
# Push the MobileNetV3 tflite into the app's private filesDir.
# Build with scripts/build_mnv3.py (produces mnv3_fp16.tflite), then:
...
echo "done — launch the MobileNetV3 app."
