...
/**
 * Draws the crowd density heatmap over the camera preview, aligned to what PreviewView shows.
 *
 ...
 * into that same rect so the overlay lines up with the crowd instead of being stretched
 * to the full view.
 */
class DensityOverlayView(context: Context) : View(context) {
