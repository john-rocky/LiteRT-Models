...
cfg=os.path.join(root,".mim/configs/animal_2d_keypoint/rtmpose/ap10k/rtmpose-m_8xb64-210e_ap10k-256x256.py")
ckpt="https://download.openmmlab.com/mmpose/v1/projects/rtmposev1/rtmpose-m_simcc-ap10k_pt-aic-coco_210e-256x256-7a041aa1_20230206.pth"
...
if __name__=="__main__":
    ...
    import litert_torch
    fp32=os.path.join(HERE,"rtm_animal.tflite"); litert_torch.convert(w,(img,)).export(fp32)
    to_fp16(fp32, os.path.join(HERE,"rtm_animal_fp16.tflite")); opcheck(os.path.join(HERE,"rtm_animal_fp16.tflite"),"rtm_fp16")
    it=opcheck(fp32,"rtm")
