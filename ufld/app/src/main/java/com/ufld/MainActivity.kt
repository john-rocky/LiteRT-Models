...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var overlayView: LaneOverlayView
    ...
    private fun initUi() {
        ...
        overlayView = LaneOverlayView(this)
        statusText = TextView(this).apply {
            setTextColor(0xFFFFFFFF.toInt()); setShadowLayer(4f, 0f, 0f, 0xFF000000.toInt())
            textSize = 16f; setPadding(24, 48, 24, 0); text = "Loading UFLD (GPU)..."
        }
    ...
    private fun loadModel() {
        backgroundExecutor.execute {
            try {
                detector = LaneDetector(this)
                statusText.post { statusText.text = "UFLD GPU ready — lane detection" }
