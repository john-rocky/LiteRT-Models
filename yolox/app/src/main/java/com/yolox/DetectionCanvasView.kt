...
class DetectionCanvasView(context: Context) : View(context) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Match PreviewView's FILL_CENTER: uniform scale + center crop. Preview and
        // analysis share a 4:3 aspect (see RealtimeCameraPipeline), so this lines the
        // boxes up with the preview.
