...
/** Decode any audio Uri to mono 16 kHz float PCM (MediaExtractor + MediaCodec, synchronous). Copied from the diarization sample. */
object AudioDecoder {
    ...
    fun decode(ctx: Context, uri: Uri, maxSeconds: Int): FloatArray {
        ...
        return resampleLinear(mono, srcRate, SAMPLE_RATE, maxSeconds)
    }
