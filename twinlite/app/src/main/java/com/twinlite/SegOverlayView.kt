...
/**
 * Draws the drivable-area + lane overlay over the camera preview, aligned to what PreviewView
 * shows (FILL_CENTER: frame scaled by max(view/frame), centered, overflow cropped).
 */
