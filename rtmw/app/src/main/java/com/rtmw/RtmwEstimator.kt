...
/**
 * RTMW whole-body pose (133 keypoints: body + feet + face + hands) on the LiteRT CompiledModel GPU.
 *   image[1,3,256,192] (ImageNet 0-255 normalized) -> simcc_x[1,133,192*2], simcc_y[1,133,256*2]
 *
 ...
 */
class RtmwEstimator(ctx: Context, accelerator: Accelerator = Accelerator.GPU) : Closeable {
    ...
    companion object {
        ...
        const val K = 133
        const val SPLIT = 2
        const val MODEL = "rtmw_fp16.tflite"
